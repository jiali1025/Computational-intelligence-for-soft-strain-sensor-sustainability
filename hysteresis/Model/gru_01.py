...
dataset = StrainDataset('./cycle_180_190_time.csv', 'train', 35, transforms=None)  # 定义一个Dataset类
dataset_tt = StrainDataset('./cycle_190_195_test.csv', 'test', 35, transforms=None)  # 定义一个Dataset类
...
plot_pred(model_tt_data, model, device)
plot_pred_time(model_tt_data, model, device)
