...
class StrainDataset(Dataset):
    def __init__(self, path, mode='train', sequence_length=500, transforms=None):
        ...
        with open(path, 'r') as fp:
            ...
            data = np.array(data)
            features = data[2::5, 2:5]
            target = data[2::5, 5:6]
            all_time = data[2::5, 2:3]
            resistance_f = data[2::5, 3:4]
            cycle_num = data[2::5, 4:5]
...
dataset_for_train = StrainDataset('./merged_after_processed_sensor23.csv', 'train', 500, transforms=None)
dataset_for_test_02 = StrainDataset('./after_processed_sensor1_0903_0_100_.csv', 'test', 500, transforms=None)
dataset_for_test_03 = StrainDataset('./after_processed_sensor1_0903_1000_1100.csv', 'test', 500, transforms=None)
dataset_for_test_04 = StrainDataset('./after_processed_sensor1_0903_2000_2100.csv', 'test', 500, transforms=None)
dataset_for_test_05 = StrainDataset('./after_processed_sensor1_0903_3000_3100.csv', 'test', 500, transforms=None)
dataset_for_test_06 = StrainDataset('./after_processed_sensor1_0903_4000_4100.csv', 'test', 500, transforms=None)
dataset_for_test_07 = StrainDataset('./after_processed_sensor1_0903_5000_5100.csv', 'test', 500, transforms=None)
dataset_for_test_08 = StrainDataset('./after_processed_sensor1_0903_6000_6100.csv', 'test', 500, transforms=None)
...
model_tt_dataX02 = DataLoader(dataset_for_test_02, batch_size=batch_size, shuffle=False, drop_last=True)
model_tt_dataX03 = DataLoader(dataset_for_test_03, batch_size=batch_size, shuffle=False, drop_last=True)
model_tt_dataX04 = DataLoader(dataset_for_test_04, batch_size=batch_size, shuffle=False, drop_last=True)
model_tt_dataX05 = DataLoader(dataset_for_test_05, batch_size=batch_size, shuffle=False, drop_last=True)
model_tt_dataX06 = DataLoader(dataset_for_test_06, batch_size=batch_size, shuffle=False, drop_last=True)
model_tt_dataX07 = DataLoader(dataset_for_test_07, batch_size=batch_size, shuffle=False, drop_last=True)
model_tt_dataX08 = DataLoader(dataset_for_test_08, batch_size=batch_size, shuffle=False, drop_last=True)
...
config = {
    'n_epochs': 5,
    'early_stop': 100,
    'save_path': 'App_DFormer_models/App2_DFormer1.pth'
}
...
preds02, test_loss02 = test(model_tt_dataX02, model, device)
preds03, test_loss03 = test(model_tt_dataX03, model, device)
preds04, test_loss04 = test(model_tt_dataX04, model, device)
preds05, test_loss05 = test(model_tt_dataX05, model, device)
preds06, test_loss06 = test(model_tt_dataX06, model, device)
preds07, test_loss07 = test(model_tt_dataX07, model, device)
preds08, test_loss08 = test(model_tt_dataX08, model, device)

print(preds02, preds03, preds04, preds05, preds06, preds07, preds08)
print(test_loss02, test_loss03, test_loss04, test_loss05, test_loss06, test_loss07, test_loss08)
...
def save_pred(preds, file):
    ...
    with open(file, 'w') as fp:
        ...
        for i, p in enumerate(preds):
            writer.writerow([i, p])
save_pred(preds02, 'App_2DFormer1_t02.csv')
save_pred(preds03, 'App_2DFormer1_t03.csv')
save_pred(preds04, 'App_2DFormer1_t04.csv')
save_pred(preds05, 'App_2DFormer1_t05.csv')
save_pred(preds06, 'App_2DFormer1_t06.csv')
save_pred(preds07, 'App_2DFormer1_t07.csv')
save_pred(preds08, 'App_2DFormer1_t08.csv')
