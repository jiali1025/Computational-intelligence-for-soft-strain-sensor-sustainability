...
class StrainDataset(Dataset):
    def __init__(self, path, mode='train', sequence_length=500, transforms=None):
        ...
        with open(path, 'r') as fp:
            ...
            data = np.array(data)
            features = data[1::30, 1:9]
            target = data[1::30, 10:12]
            all_time = data[1::30, 2:3]
            resistance_f = data[1::30, 2:3]
            cycle_num = data[1::30, 9:10]
...
dataset_for_train = StrainDataset('./training_01_03_04cycle_.csv', 'train', 500, transforms=None)
dataset_for_test_01 = StrainDataset('./testing_02_cycle_.csv', 'test', 500, transforms=None)
...
config = {
    'n_epochs': 100,
    'early_stop': 100,
    'save_path': 'Appli_Dformer_01/robotic_arm_D_Former_01.pth'
}
...
def plot_pred(dv_x,model,device,lim_x=60,lim_y=4000.,preds=None,targets=None, title=''):
    '''plot prediction of your ConvRoformer'''
...
save_pred(preds01, targets01, 'robotic_arm_D_Former_all_Preds01.csv')
