...
os.makedirs('Durability_LSTM_01', exist_ok=True)   # The trained model will be saved to ./models/
config = {
        'n_epochs': 100,
        'batch_size': 64,
        'optimizer': 'SGD',
...
# print(len(len_dev))
# plot_learning_curve(model_loss_record, title='LSTM model')
...
save_pred(preds01, 'Durability_LSTM_01_Preds.csv')
