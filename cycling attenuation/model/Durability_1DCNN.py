...
os.makedirs('Durability_1DCNN_01', exist_ok=True)
config = {
        'n_epochs': 100,
        'batch_size': 36,
        'optimizer': 'Adam',
...
# print(len(len_dev))
# plot_learning_curve(model_loss_record, title='1dCNN model')
...
print(preds01)
print(test_loss01)
save_pred(preds01, 'Durability_1DCNN_01_Preds.csv')  # save prediction file to pred.csv
