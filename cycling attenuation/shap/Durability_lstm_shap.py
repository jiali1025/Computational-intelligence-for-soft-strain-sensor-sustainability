...
model = LSTMpred(input_size=2, hidden_size=64, num_layers=2, batch_first=True)  # 构建LSTM网络
...
config = {
    ...
    'early_stop': 100,
    'save_path': 'Durability_LSTM_01/Durability_LSTM_01.pth'
}
...
model_tt_data = DataLoader(dataset_for_test_01, batch_size=batch_size, shuffle=False, drop_last=True)
...
bakcgroundshape = background_01[2]
...
pred_test_shape = []
for X_test, Y_test, T_test, R_test, C_test in model_tt_data:
...
save_pred(shap_val, 'Durability_LSTM_Shap_01.csv')
