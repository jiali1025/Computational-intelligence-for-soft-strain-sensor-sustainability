...
print(len(model_tr_data))       # -> S_train
print(len(model_dev_data))      # -> S_dev
print(len(model_tt_dataX01))    # -> S_test
...
os.makedirs('Durability_D_Former', exist_ok=True)
config = {
    'n_epochs': 10,
    'early_stop': 100,
    'save_path': 'Durability_D_Former/Durability_D_Former_01.pth'
}
...
save_pred(preds01, targets01, 'Durability_D_Former_01_Preds.csv')
