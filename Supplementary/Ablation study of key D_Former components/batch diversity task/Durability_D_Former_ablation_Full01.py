...
os.makedirs('Durability_D_Former_ablation01_1', exist_ok=True)
config = {
    'n_epochs': 10,
    'early_stop': 100,
    'save_path': 'Durability_D_Former_ablation01_1/Durability_D_Former_01.pth'
}
...
save_pred(preds01, targets01, 'Durability_D_Former_ablation01_Preds_01.csv')
