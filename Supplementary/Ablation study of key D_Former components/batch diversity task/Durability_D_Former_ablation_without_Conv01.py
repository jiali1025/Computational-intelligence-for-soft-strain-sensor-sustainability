...
class D_Former_NoConv(nn.Module):
    ...
    def forward(self, src: Tensor) -> Tensor:
        ...
        z_embedding = self.input_embedding(src)  # identity -> same shape
...
os.makedirs('Durability_D_Former_ablation02_1', exist_ok=True)
config = {
    'n_epochs': 10,
    'early_stop': 100,
    'save_path': 'Durability_D_Former_ablation02_1/Durability_D_Former_01.pth'
}
...
# --------------------- Training function (single-group optimizer) ---------------------
...
save_pred(preds01, targets01, 'Durability_D_Former_ablation02_Preds_01.csv')
