...
os.makedirs('Durability_D_Former_ablation03', exist_ok=True)
config = {
    'n_epochs': 10,
    'early_stop': 100,
    'save_path': 'Durability_D_Former_ablation03/Durability_D_Former_01.pth'
}
...
save_pred(preds01, targets01, 'Durability_D_Former_ablation03_Preds_1.csv')
