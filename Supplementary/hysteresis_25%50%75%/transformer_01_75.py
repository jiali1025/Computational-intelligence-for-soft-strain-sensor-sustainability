...
dataset_for_train = StrainDataset('./75cycle_le10_40_45_.csv', 'train', 200, transforms=None)
dataset_for_test = StrainDataset('./75cycle_40_45.csv', 'test', 200, transforms=None)
...
os.makedirs('Transformer_75', exist_ok=True)
config = {
    'n_epochs': 120,
    'early_stop': 100,
    'save_path': 'Transformer_75/model_transformer_01.pth'
}
...
save_pred(preds, targets, '75pred_transformer_01.csv')
print('ALL Done!')
