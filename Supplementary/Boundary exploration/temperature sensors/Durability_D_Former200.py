...
dataset_for_train = StrainDataset('./temperature_train_cycles_0-199_55.csv', 'train', 500, transforms=None)
dataset_for_test_01 = StrainDataset('./temperature_test_cycles_200-659_55.csv', 'test', 500, transforms=None)
...
os.makedirs('Temperature200_D_Former_01', exist_ok=True)
config = {
    'n_epochs': 100,
    'early_stop': 100,
    'save_path': 'Temperature200_D_Former_01/Durability_D_Former_01.pth'
}
...
class MAPELoss(nn.Module):
    ...
    def forward(self, predictions, targets):
        loss = torch.mean(torch.abs((targets - predictions) / (7)))
        return loss
...
# save_pred(preds01, targets01, 'Temperature200_D_Former_01_Preds.csv')
