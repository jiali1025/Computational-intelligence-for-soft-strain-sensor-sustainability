...
dataset_for_train = StrainDataset('./temperature_train_cycles_0-99_55.csv', 'train', 500, transforms=None)
dataset_for_test_01 = StrainDataset('./temperature_test_cycles_100-659_55.csv', 'test', 500, transforms=None)
...
os.makedirs('Temperature100_D_Former_01', exist_ok=True)
config = {
    'n_epochs': 100,
    'early_stop': 100,
    'save_path': 'Temperature100_D_Former_01/Durability_D_Former_01.pth'
}
...
# save_pred(preds01, targets01, 'Temperature100_D_Former_01_Preds.csv')
