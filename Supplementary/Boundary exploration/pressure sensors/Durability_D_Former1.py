...
dataset_for_train = StrainDataset('./pressure_train_cycles_0.csv', 'train', 5, transforms=None)
dataset_for_test_01 = StrainDataset('./pressure_test_cycles_1-2478.csv', 'test', 5, transforms=None)
...
class D_Former(nn.Module):
    def __init__(self, d_model: int):
        ...
        self.input_embedding = causal_convolution_layer.context_embedding(5, d_model, 5)
    ...
    def forward(self, src: Tensor) -> Tensor:
        ...
        z_embeoutput = z_embedding.reshape(8, -1, 24)
...
os.makedirs('Pressure1_D_Former_01', exist_ok=True)
config = {
    'n_epochs': 120,
    'early_stop': 100,
    'save_path': 'Pressure1_D_Former_01/Durability_D_Former_01.pth'
}
...
#
#             y_denorm = y * dataset_for_train.y_std + dataset_for_train.y_mean
#             pred_denorm = pred * dataset_for_train.y_std + dataset_for_train.y_mean
#             batch_mape_loss = criterion1(pred_denorm, y_denorm )
#
...
# save_pred(preds01_raw, targets01_raw, 'Pressure1_D_Former_01_Preds1.csv')
