...
dataset_for_train = StrainDataset('./pressure_train_cycles_0-4.csv', 'train', 500, transforms=None)
dataset_for_test_01 = StrainDataset('./pressure_test_cycles_5-2478.csv', 'test', 500, transforms=None)
...
os.makedirs('Pressure5_D_Former_01', exist_ok=True)
config = {
    'n_epochs': 120,
    'early_stop': 100,
    'save_path': 'Pressure5_D_Former_01/Durability_D_Former_01.pth'
}
...
# save_pred(preds01_raw, targets01_raw, 'Pressure5_D_Former_01_Preds1.csv')
