...
dataset_for_train = StrainDataset('./01_training_data_1000.csv', 'train', 500, transforms=None)
dataset_for_test_01 = StrainDataset('./merged_testing_19000.csv', 'test', 500, transforms=None)
...
os.makedirs('Durability_D_Former_1000', exist_ok=True)
config = {
    'n_epochs': 60,
    'early_stop': 100,
    'save_path': 'Durability_D_Former_1000/Durability_D_Former1000_01.pth'
}
...
# save_pred(preds01, targets01, 'Durability_D_Former_1000_Preds.csv')
