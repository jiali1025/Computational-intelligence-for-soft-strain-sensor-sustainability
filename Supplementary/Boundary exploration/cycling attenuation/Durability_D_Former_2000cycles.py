...
dataset_for_train = StrainDataset('./01_training_data_2000.csv', 'train', 500, transforms=None)
dataset_for_test_01 = StrainDataset('./merged_testing_18000.csv', 'test', 500, transforms=None)
...
os.makedirs('Durability_D_Former_2000', exist_ok=True)
config = {
    'n_epochs': 60,
    'early_stop': 100,
    'save_path': 'Durability_D_Former_2000/Durability_D_Former_01.pth'
}
...
# save_pred(preds01, targets01, 'Durability_D_Former_2000_Preds.csv')
