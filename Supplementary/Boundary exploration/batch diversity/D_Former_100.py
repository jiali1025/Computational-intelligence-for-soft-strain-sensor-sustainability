...
dataset_for_train = StrainDataset('./Training_batchdiversity_1589filtered100.csv', 'train', 500, transforms=None)
...
os.makedirs('BatchDiversity_100cycles_D_Former_1589models', exist_ok=True)
config = {
    'n_epochs': 100,
    'early_stop': 100,
    'save_path': 'BatchDiversity_100cycles_D_Former_1589models/BatchDiversity_D_Former_01.pth'
}
...
save_pred(preds01, targets01, 'BatchDiversity_100cycles_D_Former_01.csv')
