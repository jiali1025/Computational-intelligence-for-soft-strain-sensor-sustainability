...
# -------------------------------------DataLoader---------------------------------------------
os.makedirs('BatchDiversity_GRU_models/BatchDiversity_GRU_01_1589Preds3', exist_ok=True)
config = {
    'n_epochs': 100,
    'batch_size': 36,
    'optimizer': 'Adam',
    ...
    'early_stop': 100,
    'save_path': 'BatchDiversity_GRU_models/BatchDiversity_GRU_01_1589Preds3.pth'
}
...
def main():
    ...
    # summary
    summary_csv = 'BatchDiversity_GRU_multi_seed_summary.csv'
